        ...
        <div class="user-card">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" method="post" id="registerForm" action="#">
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="name" id="txtuserID"
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="name" id="txtuserName"
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="email" id="txtaddress"
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="username" id="txtcontact"
                    ...
                    <div class="form-group ">
                        <button type="button" id="btnSave" class="btn btn-primary btn-lg btn-block login-button">
                            Registration
                        </button>
                    </div>
